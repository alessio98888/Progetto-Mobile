...
public class ProgrammableMetronomePresetsProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.example.guitartrainer.metronome.ProgrammableMetronomePresetsProvider";
    ...
    public String getType(@NonNull Uri uri) {
        return "com.example.guitartrainer.metronome.ProgrammableMetronomePreset";
    }
