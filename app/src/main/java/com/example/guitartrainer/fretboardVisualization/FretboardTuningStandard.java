...
public class FretboardTuningStandard extends FretboardTuning implements Serializable {
    ...
    private HashMap<GuitarFretboardNotesKey, MusicalNote.MusicalNoteName> fretBoardMap;
    ...
    HashMap<Integer, MusicalNote.MusicalNoteName> fretboardOpenStringsMapStandardTuning =
    ...
    @Override
    public HashMap<GuitarFretboardNotesKey, MusicalNote.MusicalNoteName> getMap() {
        if(getMapAlreadyCalled)
            return fretBoardMap;
        getMapAlreadyCalled = true;

        HashMap<GuitarFretboardNotesKey, MusicalNote.MusicalNoteName> standardMap
