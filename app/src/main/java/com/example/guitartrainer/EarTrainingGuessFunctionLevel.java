...
public class EarTrainingGuessFunctionLevel {
    ...
    public void addEarTrainingCardWithObjects(Context context,
       ...
       addEarTrainingCard(context, parentLayout, cardMusicalScale.toString(),
               octaveOption.getReadableOctaveOption(), cardMusicalProgression.getReadableProgressionEnum(), bestScoreTextString,
               mainTitleTextColor, numberOctavesTextColor, progressionTextColor, bestScoreTextColor,
               cardBackgroundColor, height, width, cardAbove);
    }
    ...
    public void addEarTrainingCardWithObjectsAndDefaults(Context context,
        ...
        addEarTrainingCard(context, parentLayout, cardMusicalScale.toString(),
                ...
                cardMusicalProgression.getReadableProgressionEnum(), bestScoreTextString,
